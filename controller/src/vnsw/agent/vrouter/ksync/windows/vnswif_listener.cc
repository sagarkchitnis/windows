...
void
VnswInterfaceListenerWindows::InitNetlinkScan(uint32_t type, uint32_t seqno) {
	struct nlmsghdr *nlh;
...
void VnswInterfaceListenerWindows::ReadHandler(
...
****************************************************************************/
int VnswInterfaceListenerWindows::AddAttr(uint8_t *buff, int type, void *data, int alen) {
...
void VnswInterfaceListenerWindows::UpdateLinkLocalRoute(const Ip4Address &addr,
	bool del_rt) {
	struct nlmsghdr *nlh;
	struct rtmsg *rtm;
	uint32_t ipaddr;
...
****************************************************************************/
string VnswInterfaceListenerWindows::NetlinkTypeToString(uint32_t type) {
	switch (type) {
	case NLMSG_DONE:
		return "NLMSG_DONE";
	case RTM_NEWADDR:
...
VnswInterfaceListenerWindows::HandleNetlinkRouteMsg(struct nlmsghdr *nlh) {
...
VnswInterfaceListenerBase::Event *
VnswInterfaceListenerWindows::HandleNetlinkIntfMsg(struct nlmsghdr *nlh) {
...
VnswInterfaceListenerBase::Event *
VnswInterfaceListenerWindows::HandleNetlinkAddrMsg(struct nlmsghdr *nlh) {
...
int VnswInterfaceListenerWindows::NlMsgDecode(struct nlmsghdr *nl,
